#ifndef BENCHMARK_CUCKOOMAP_H
#define BENCHMARK_CUCKOOMAP_H
...
public:
    ...
    CuckooMap(uint32_t SIZE){
        inserted = 0;
        length = (SIZE / LOAD / ARRAY_NUM / SLOT_PER_BUCKET);
    ...
    void Insert(KEY_TYPE key, VALUE_TYPE value){
        ...
        std::cout << "Hash Insert Error" << std::endl;
    }
    ...
    void Replace(KEY_TYPE key, VALUE_TYPE value){
        ...
        std::cout << "Hash Replace Error" << std::endl;
    }
    ...
    VALUE_TYPE operator [] (KEY_TYPE key){
        ...
        std::cout << "Hash Find Error" << std::endl;
    }
    ...
    void Delete(KEY_TYPE key){
        ...
        std::cout << "Hash Delete Error" << std::endl;
    }
